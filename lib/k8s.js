...
var VcapClient = module.exports = function (info) {
    ...
    /*
      OpenShift v3 specific collections
     */
    this.routes = collections.create('routes');
    this.imageStreams = collections.create('imageStreams');
    this.buildConfigs = collections.create('buildConfigs');
    this.deploymentConfigs = collections.create('deploymentConfigs');
